  ...
  <?php include ("header.php");?>
	<div role="main" class="main main-page">
				...
				<div class="container">
											<div class="row">
							<div class="col-md-12">
																<div class="ptitle">Career Programs</div>
																<div id="breadcrumbs"><ul class="breadcrumb"><li><a href="http://exincorpacademy.com/">Home</a></li><li><a href="http://exincorpacademy.com/services.php">services</a></li><li><a href="http://exincorpacademy.com/careers.php">career programs</a></li> </ul> </div>
							</div>
						</div>
									</div>
			</section>
  ...
  <div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="course-image">
           <div class="field field-name-field-course-image field-type-image field-label-hidden"><div class="field-items"><div class="field-item even"><img typeof="foaf:Image" src="images/up.jpg" style="width:100%;" alt="" height="650"/></div></div></div>        </div>
...
<br/>
        <div class="course-content">
		  ...
		  <div class="course-content course-features margin-top-45">
          <h3>Infrastructure Career Programs</h3><br>
    <div class="row">  
                                      <div class="clearfix col-md-6 col-sm-6 col-xs-12 feature-item ">
                                       ...
                                       <i class="fa fa-check"></i><span>MCITP & CCNA </span>
                                       ...
                                       <i class="fa fa-check"></i><span>RHCVA & RHCDS</span>
                                       </div>
