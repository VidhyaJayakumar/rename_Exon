 ...
 <?php include ("header.php");?>
	<div role="main" class="main main-page">
				...
				<div class="container">
											<div class="row">
							<div class="col-md-12">
																<div class="ptitle">Onsite Training</div>
																<div id="breadcrumbs"><ul class="breadcrumb"><li><a href="http://exincorpacademy.com/">Home</a></li> <li><a href="http://exincorpacademy.com/services.php">Services</a></li><li><a href="http://exincorpacademy.com/onsite.php">Onsite training  </a></li></ul> </div>
							</div>
						</div>
									</div>
			</section>
  ...
  <div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="course-image">
           <div class="field field-name-field-course-image field-type-image field-label-hidden"><div class="field-items"><div class="field-item even"><img typeof="foaf:Image" src="images/onsite-training-in-vellore.jpg" width="100%" height="650" alt="" /></div></div></div>        </div>
...
<br/>
        <div class="course-content">
          <div class="field field-name-body field-type-text-with-summary field-label-hidden"><div class="field-items"><div class="field-item even" property="content:encoded"> <h1>Onsite Training</h1><p align="justify">World-class training from exincorp at your location. <br/><br/>With on-site training from exincorp, it's easy to ensure that your team has the right skills to maximize your technology investment.
		If you've got several people to train in the same technology, or you need training customized for a non-standard technology deployment, there's no need to travel for the training you need. 
		On-site training saves money by eliminating travel and hotel expenses. 
		You also enjoy greater flexibility and more control, factors that can provide stronger results.</p>

</div></div></div>        </div>

                  <div class="course-features margin-top-45">
            <h3>Benifits of On-site Training</h3><br>
            <div class="row">  
                                      <div class="clearfix col-md-6 col-sm-12 col-xs-12 feature-item "><i class="fa fa-check"></i><span>No need to travel </span></div>
                                        <div class="clearfix col-md-6 col-sm-12 col-xs-12 feature-item clearfix last"><i class="fa fa-check"></i><span>Customized Training</span></div>
                                        <div class="clearfix col-md-6 col-sm-12 col-xs-12 feature-item "><i class="fa fa-check"></i><span>Minimize downtime</span></div>
                                        <div class="clearfix col-md-6 col-sm-12 col-xs-12 feature-item clearfix last"><i class="fa fa-check"></i><span>Consistent learning experience</span></div>
                                        <div class="clearfix col-md-6 col-sm-12 col-xs-12 feature-item "><i class="fa fa-check"></i><span>Courses can be planned around individual and department schedules and delivered inany format</span></div>
                                        <div class="clearfix col-md-6 col-sm-12 col-xs-12 feature-item clearfix last"><i class="fa fa-check"></i><span>Get all employees on the same wavelength</span></div>
                              </div>  
          </div>
		  <div class="course-content">
          <div class="field field-name-body field-type-text-with-summary field-label-hidden"><div class="field-items"><div class="field-item even" property="content:encoded"> <br><h3>Your organization reaps the rewards financially</h3><p align="justify">Factor in the cost of multiple registrations and you generally save money with a class of five or more participants. Plus, eliminate staff travel time and cost when you let us come to you. </p>
<p></p><br><br>
</div></div></div>        </div>
