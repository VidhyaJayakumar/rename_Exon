...
<article id="node-109" class="node node-course node-promoted post single-course" about="/educar/content/yoga-and-meditation-everyone" typeof="sioc:Item foaf:Document">
 ...
 <div class="container">        <div class="block  wow fadeInUp panel-pane pane-block pane-views-team-block margin-bottom-0 pane-views"  >
      ...
      <div class="pane-content">
        <div class="view view-team view-id-team view-display-id-block view-dom-id-f2720978d0e0f94e5993f90e28d7a09c">
            <div class="view-header">
      <div class="block-description">We are not the team because we work together,We are the team because we Respect,Trust,Care Each other  </div>
    </div>
  ...
  <div class="views-field views-field-nothing">        <div class="field-content"><div class="image">
    <div class="avata">
            <img typeof="foaf:Image" src="sites/default/files/team-img/team-5.jpg" width="440" height="295" alt="" />
     </div>
</div>
<div class="team-content">
  ...
  <div class="views-field views-field-nothing">        <div class="field-content"><div class="image">
    <div class="avata">
            <img typeof="foaf:Image" src="sites/default/files/team-img/team-4.jpg" width="440" height="295" alt="" />
     </div>
</div>
<div class="team-content">
  ...
  <div class="views-field views-field-nothing">        <div class="field-content"><div class="image">
    <div class="avata">
            <img typeof="foaf:Image" src="sites/default/files/team-img/team-3.jpg" width="440" height="295" alt="" />
     </div>
</div>
<div class="team-content">
  ...
  <div class="views-field views-field-nothing">        <div class="field-content"><div class="image">
    <div class="avata">
            <img typeof="foaf:Image" src="sites/default/files/team-img/team-2.jpg" width="440" height="295" alt="" />
     </div>
</div>
<div class="team-content">
      <div class="name"><a href="#">Vera Farmiga</a></div>
      <div class="job">professor, spanish</div>
     <div class="team-social">
             <a class="facebook" href="#"><i class="fa fa-facebook"></i></a>
             <a class="twitter" href="#"><i class="fa fa-twitter"></i></a>
             <a class="youtube" href="#"><i class="fa fa-youtube-square"></i></a> 
  ...
  <div class="views-field views-field-nothing">        <div class="field-content"><div class="image">
    <div class="avata">
            <img typeof="foaf:Image" src="sites/default/files/team-img/team-1.jpg" width="440" height="295" alt="" />
     </div>
</div>
<div class="team-content">
      <div class="name"><a href="#">Lucille Ball</a></div>
      <div class="job">master, history</div>
     <div class="team-social">
             <a class="facebook" href="#"><i class="fa fa-facebook"></i></a>
             <a class="twitter" href="#"><i class="fa fa-twitter"></i></a>
             <a class="youtube" href="#"><i class="fa fa-youtube-square"></i></a> 
...
Our vision is to become the number one end-to-end solutions provider and demonstrate excellence in providing the best-in-class infrastructure management services to our clients in diverse horizontal and vertical segments.</p>
        ...
        <div class="course-features margin-top-45">
            <div class="course-subtitle">Managed IT Training Services - Our managed services portfolio includes</div>
            <div class="row">  
                                      <div class="clearfix col-md-6 col-sm-12 col-xs-12 feature-item "><i class="fa fa-check"></i><span>On-Site Training</span></div>
                                        ...
                                        <div class="clearfix col-md-6 col-sm-12 col-xs-12 feature-item "><i class="fa fa-check"></i><span>Career Programs</span></div>
                                        <div class="clearfix col-md-6 col-sm-12 col-xs-12 feature-item clearfix last"><i class="fa fa-check"></i><span>Boot Camp</span></div>
                                        <div class="clearfix col-md-6 col-sm-12 col-xs-12 feature-item "><i class="fa fa-check"></i><span>Academic Projects</span></div>
                                        <div class="clearfix col-md-6 col-sm-12 col-xs-12 feature-item clearfix last"><i class="fa fa-check"></i><span>Corporate Training</span></div>
                              </div>  
          </div>
