...
<body class="html front not-logged-in no-sidebars page-home-edu-v1 page-no-margin not-preloader" >
  ...
  <div role="main" class="main main-page">
        ...
        <div class="container">
                      <div class="row">
              <div class="col-md-12">
                                <div class="ptitle">Python Course in <?php echo $place; ?></div>
  ...
  <div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="course-image">
           <div class="field field-name-field-course-image field-type-image field-label-hidden"><div class="field-items"><div class="field-item even"><img typeof="foaf:Image" src="../images/Cisco3.jpg" width="1000" height="650" alt="" /></div></div></div>        </div>

        <div class="post-title">
                        <h1 ><a href="yoga-and-meditation-everyone.html">Python Training</a></h1>
        ...
        <div class="course-content">
          <div class="field field-name-body field-type-text-with-summary field-label-hidden"><div class="field-items"><div class="field-item even" property="content:encoded"><p align="justify">We at exincorp solutions specialize in offering various types of IT training and educational services which have helped IT professionals and newbie's to improve and gain knowledge in IT domain. The beautifully structured training courses help the people to gain added value and also clear all their doubts. We aim to provide valuable IT training services to our clients from private business enterprise, institutions and even to individuals. Our expert team of trainers makes use of modern teaching techniques through which they offer the clients the most reliable and satisfactory services to the clients. With our years of experience in the IT industry we come out with new innovative methods of teachings. We further offer diverse combination training program options to choose from. These programs are designed to meet the various needs of the clients. We also offer distance learning services to our clients. Our combination option program has proved successful and the friendly training environments have gained immense appreciations from our clients. Some of our combination programs which our clients can choose are as follows.</p>
            ...
            <div class="course-subtitle">Deliverables</div>
            <div class="row">  
          ...
          <p style="text-align:justify">Python Scripting is one of the easy languages to learn and is widely used from individuals to big organizations such as Google. This Python training starts with the basic syntax of Python and continues to small GUI programs. You will learn Python data types such as Tuples and Dictionaries, Looping, Functions and I/O handling. Python training will also give you an overview of Object Oriented Programming and Graphical application development. Python Scripting course will explain some basics modules and their usage. At the end of the Python Scripting Training, individuals will have the skills to grow in Web-Development, GUI Application Programming, Game Development and writing powerful scripts for System Administration.</p>
             ...
             <div class="course-subtitle margin-0">Topics Covered</div>
                      ...
                      <span class="lesson-content">
                        <span class="lesson-title">Python - Overview</span>
                      ...
                      <i class="icon fa fa-check-square-o"></i>
                      <span class="lesson-content">
                        <span class="lesson-title">Data structures</span>
                      ...
                      <i class="icon fa fa-check-square-o"></i>
                      <span class="lesson-content">
                        <span class="lesson-title">Loops</span>
                 ...
                 <div class="lesson-item">
                      <i class="icon fa fa-check-square-o"></i>
                      <span class="lesson-content">
                        <span class="lesson-title">Regular Expressions</span>
                        <span class="lesson-duration">45 min</span>
                      </span>  
                  </div>
                      ...
                      <i class="icon fa fa-check-square-o"></i>
                      <span class="lesson-content">
                        <span class="lesson-title">Debugging</span>
                        <span class="lesson-duration">55 min</span>
                      </span>  
                  </div>
                      ...
                      <i class="icon fa fa-check-square-o"></i>
                      <span class="lesson-content">
                        <span class="lesson-title">Project</span>
                        <span class="lesson-duration">2 hours</span>
                      </span>  
                  </div>
                      ...
                      <i class="icon fa fa-check-square-o"></i>
                      <span class="lesson-content">
                        <span class="lesson-title">Python Training Level-2</span>
                      ...
                      <i class="icon fa fa-check-square-o"></i>
                      <span class="lesson-content">
                        <span class="lesson-title">2D Game Development</span>
                        <span class="lesson-duration">75 min</span>
                      </span>  
                  </div>
                ...
                <div class="lesson-item">
                      <i class="icon fa fa-check-square-o"></i>
                      <span class="lesson-content">
                        <span class="lesson-title">GUI Application Programming</span>
                        <span class="lesson-duration">60 min</span>
                      </span>  
                  </div>
                      ...
                      <i class="icon fa fa-check-square-o"></i>
                      <span class="lesson-content">
                        <span class="lesson-title">Web App Development</span>
                        <span class="lesson-duration">75 min</span>
                      </span>  
                  </div>
                 ...
                 <div class="lesson-item">
                      <i class="icon fa fa-check-square-o"></i>
                      <span class="lesson-content">
                        <span class="lesson-title">Project in Python</span>
                        <span class="lesson-duration">45 min</span>
                      </span>  
                  </div>
