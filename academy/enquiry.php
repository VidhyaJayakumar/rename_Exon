...
<body class="html front not-logged-in no-sidebars page-home-edu-v1 page-no-margin not-preloader" >
   ...
   <!-- Header
	...
	<div role="main" class="main main-page">
				...
				<div class="container">
											<div class="row">
							<div class="col-md-12">
																<div class="ptitle">Enquiry</div>
																<div id="breadcrumbs"><ul class="breadcrumb"><li><a href="http://exoncorpacademy.com/">Home</a></li> <li><a href="http://exoncorpacademy.com/enquiry.php">Enquiry</a></li> </ul> </div>
							</div>
						</div>
									</div>
			</section>
  ...
  <div class="block-inner clearfix">
     ...
     <div class="block-title">
          <h4 >
            <span>Thank you for your interest in exoncorp Academy
</span>
          </h4>
        </div>
    ...
    <div class="block-content">
      <div>
        <form class="user-info-from-cookie contact-form" action="email.php" method="post" id="contact-site-form" accept-charset="UTF-8"><div><div class="form-item form-type-textfield form-item-name">
...
<div class="form-item form-type-textfield form-item-subject">
  <label for="edit-subject">Mobile <span class="form-required" title="This field is required.">*</span></label>
 <input type="text" id="edit-subject" name="subject" value="" size="60" maxlength="255" class="form-text required" />
</div>
<div class="form-item form-type-textfield form-item-subject">
  <label for="edit-subject">Course Name <span class="form-required" title="This field is required.">*</span></label>
 <input type="text" id="edit-subject" name="subject" value="" size="60" maxlength="255" class="form-text required" />
</div>

<div class="form-item form-type-textarea form-item-message">
  <label for="edit-message">Any Queries / Suggestions? <span class="form-required" title="This field is required.">*</span></label>
...
<div class="form-actions form-wrapper form-group" id="edit-actions"><input type="submit" id="edit-submit" name="op" value="Send message" class="btn-primary btn form-submit" /></div></div></form>      </div>
 ...
 you are one step closer to achieving your career goals!
    ...
    <span class="description"> <p align="justify"> Please fill out the form below and one of our representatives will get in touch with you.
</p></span><br>
<ul class="contact-info"><li><span><i class="fa fa-home"></i> No: 05/X2 , Hari Om 2nd Street, Phase III,Sathuvachari,Vellore - 632009</span> </li><br>
<li><span><i class="fa fa-mobile-phone"></i> (+91) 8189985551 | (+91) 8189985559 </span></li><br>
<li><a href="mailto:info@exoncorpacademy.com"><i class="fa fa-envelope-o"></i> info@exoncorpacademy.com</a> </li><br>
<li><span><a href="#"><i class="fa fa-whatsapp"></i> Whatsapp</span> +91 8189985551</li><br>
</ul></div>
              </div>
    </div>  
  </div>
