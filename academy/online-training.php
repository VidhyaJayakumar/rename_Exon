...
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0" />
   <title>Comming Soon -exincorp IT Academy</title>
    <meta charset="utf-8"/>
...
<body class="html not-front not-logged-in no-sidebars page-node page-node- page-node-109 node-type-course not-preloader" >
  ...
  <div role="main" class="main main-page">
        ...
        <div class="container">
                      <div class="row">
              <div class="col-md-12">
                                <!--<div class="ptitle">NETWORKING</div>
                                <div id="breadcrumbs"><ul class="breadcrumb"><li><a href="programs.php">programs</a></li> <li><a href="#">IT  Programs </a></li><!--<li><a href="Vapt.php" class="" title="">VAPT</a></li>--<li><a href="pentest.php" class="active" title="">NETWORKING</a></li> </ul> </div>-->

                               <center><h1> WE'R COMING SOON </h1></center>
              </div>
            </div>
                  </div>
      </section>
    <div id="content" class="content content-full">
      ...
      <img src="coming-soon.jpg" alt="" ;="" style="margin-left: 20px;">&#13;
    </div>&#13;
