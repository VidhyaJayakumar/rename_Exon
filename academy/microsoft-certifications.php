...
<body class="html front not-logged-in no-sidebars page-home-edu-v1 page-no-margin not-preloader" >
  ...
  <div role="main" class="main main-page">
        ...
        <div class="container">
                      <div class="row">
              <div class="col-md-12">
                                <div class="ptitle">microsoft-certifications</div>
                                <div id="breadcrumbs"><ul class="breadcrumb"><li><a href="index.php">Home</a></li> <li><a href="microsoft-certifications" title="" class="active">microsoft-certifications</a></li> </ul> </div>
              </div>
            </div>
                  </div>
      </section>
  ...
  <div class="block-inner clearfix">
   ...
   <div class="grid-inner col-inner">
      <div class="image">  
            <div class="field-content"><img typeof="foaf:Image" src="../../images/microsoft-server-training-vellore.png" width="700" height="525" alt="" /></div>            
      </div>  
      <div class="item-body">
         <div class="title"> 
            <span class="field-content"><a href="microsoft-server.php">Server</a></span>         </div>  
         <div class="teacher"> 
            <div class="field-content"><a href="#">Selvarathinam</a></div>         </div>
         <div class="body">        
            <div class="field-content"><p>A server is a computer or device on a network that manages network resources.</p></div>         </div>
         <div class="readmore">        
            <a href="microsoft-server.php">View more</a>
         </div>
      </div>
   </div>
</div>  
   ...
   <div class="grid-inner col-inner">
      ...
      <div class="item-body">
         <div class="title"> 
            <span class="field-content"><a href="microsoft-desktop.php">Desktop</a></span>         </div>  
         <div class="teacher"> 
            <div class="field-content"><a href="#">Siva Priya</a></div>         </div>
         <div class="body">        
            <div class="field-content"><p>A desktop computer is a personal computer designed for regular use at a single location.</p></div>         </div>
         <div class="readmore">        
            <a href="microsoft-desktop.php">View more</a>
         </div>
      </div>
   </div>
</div>  
   ...
   <div class="grid-inner col-inner">
      <div class="image">  
            <div class="field-content"><img typeof="foaf:Image" src="../../images/msoffice.jpg" width="700" height="525" alt="" /></div>          
      </div>  
      <div class="item-body">
         <div class="title"> 
            <span class="field-content"><a href="microsoft-office.php">Office</a></span>         </div>  
         <div class="teacher"> 
            <div class="field-content"><a href="#">Francis Mohan</a></div>         </div>
         <div class="body">        
            <div class="field-content"><p>Office 365 is the best way to get the full Microsoft Office experience.</p></div>         </div>
         <div class="readmore">        
            <a href="microsoft-office.php">View more</a>
         </div>
      </div>
   </div>
</div>  
   ...
   <div class="grid-inner col-inner">
      <div class="image">  
            <div class="field-content"><img typeof="foaf:Image" src="../../images/microsoft-server-training-vellore.png" width="600" height="425" alt="" /></div>            
      </div>  
      <div class="item-body">
         <div class="title"> 
