...
<?php include ("header.php");?>
	<div role="main" class="main main-page">
				...
				<div class="container">
											<div class="row">
							<div class="col-md-12">
																<div class="ptitle">Webinars</div>
																<div id="breadcrumbs"><ul class="breadcrumb"><li><a href="http://exincorpacademy.com/">Home</a></li><li><a href="http://exincorpacademy.com/services.php">services</a></li><li><a href="http://exincorpacademy.com/upcoming.php">webinars</a></li>  </ul> </div>
							</div>
						</div>
									</div>
			</section>
  ...
  <div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="course-image">
           <div class="field field-name-field-course-image field-type-image field-label-hidden"><div class="field-items"><div class="field-item even"><img typeof="foaf:Image" src="images/webinars-training-in-vellore.jpg" style="width:100%;" alt="" height="650"/></div></div></div>        </div>
...
<br/>
        <div class="course-content">
          <div class="field field-name-body field-type-text-with-summary field-label-hidden"><div class="field-items"><div class="field-item even" property="content:encoded"> <div class="course-features margin-top-45">
            <h1>How NFPA Is Bringing Paper Processes Online With Drupal 8</h1><br>
            <div class="row">  
                                      <div class="clearfix col-md-12 col-sm-12 col-xs-12 feature-item ">
                                      <i class="fa fa-check"></i><span>Locate upcoming Drupal 8 and open source events around the world. Register for upcoming webinars or watch archived ones on demand. </span><br>
                                       <i class="fa fa-check"></i><span>Drupal 8</span><br>
                                       <i class="fa fa-check"></i><span>Firewise USA™'s paper application process existed for 15 years but, in 2016, the Firewise team decided to bring the process online. They chose to build this process on top of Drupal 8.</span><br>
                                       <i class="fa fa-check"></i><span>Organizational hurdles to overcome when adding structure and bringing an established paper application process online. </span><br>
                                       
                                       
                                       <i class="fa fa-check"></i><span>Leveraging an agile philosophy to respond quickly to change, collaborate across disciplines and stakeholder groups and get to a working product in as little amount of time as possible.</span><br>
                                       <i class="fa fa-check"></i><span>Balancing effective deliverables with shared understanding to produce working software that meets the organization’s needs. </span><br> <br>
