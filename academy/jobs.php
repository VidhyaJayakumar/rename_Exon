  ...
  <div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="course-image">
           <div class="field field-name-field-course-image field-type-image field-label-hidden"><div class="field-items"><div class="field-item even"><img typeof="foaf:Image" src="sites/default/files/jobs.jpg" width="100%" height="500" alt="" /></div></div></div>        </div>
...
<div class="form-item form-type-textfield form-item-name col-md-6">
 <label for="edit-name">Upload </label>
    <label class="btn btn-primary">
 <input type="file" id="edit-name" name="file[]" value="" size="30" maxlength="60" class="form-text" pattern="^[789]\d{9}$" required/>
    </label>
</div>
