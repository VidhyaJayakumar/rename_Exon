...
<?php include ("header.php");?>
	<div role="main" class="main main-page">
				...
				<div class="container">
											<div class="row">
							<div class="col-md-12">
																<div class="ptitle">Workshop</div>
																<div id="breadcrumbs"><ul class="breadcrumb"><li><a href="index.php">Home</a></li> <li><a href="services.php">Services</a></li> <li><a href="services/workshop.php">Workshop</a></li> </ul> </div>
							</div>
						</div>
									</div>
			</section>
...
<article id="node-109" class="node node-course node-promoted post single-course" about="/educar/content/yoga-and-meditation-everyone" typeof="sioc:Item foaf:Document">
        ...
        <div class="course-image">
           <div class="field field-name-field-course-image field-type-image field-label-hidden"><div class="field-items"><div class="field-item even"><img typeof="foaf:Image" src="images/workshop-training-in-vellore.jpg" width="100%" height="650" alt="" /></div></div></div>        </div>
  ...
  <div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          ...
          <div class="field field-name-body field-type-text-with-summary field-label-hidden"><div class="field-items"><div class="field-item even" property="content:encoded"> <br><div class="course-subtitle">Benefits of Attending a Workshop</div><p align="justify">For a breakthrough experience that leads to action-oriented decisions, workshops are often more effective than classic modes of interaction. Larger groups of stakeholders can be proactively engaged in a single forum through which participants gain deeper and improved understanding of business challenges and issues. Current thinking is challenged, and differences are identified and voiced in real-time. New insights are generated, providing a foundation for possible solutions. Collective alignment is built for the way forward. Commitment to action is established and a realistic roadmap is agreed upon.</p>
<p></p>
</div></div></div>        </div>
...
<article id="node-19" class="node node-blog node-promoted post post-large blog-single-post" about="/educar/node/19" typeof="sioc:Post sioct:BlogPost">
    ...
    <section id="comment-form-wrapper">
      <h3>Register Here</h3>
      <form class="comment-form" action="db.php" method="post" id="comment-form" accept-charset="UTF-8"><div>
...
<div class="form-item form-type-textfield form-item-name col-md-6">
 ...
 <input type="text" id="edit-name" name="location" value="" size="30" maxlength="60" class="form-text" required />
</div>
<div class="form-item form-type-textfield form-item-name col-md-6">
  <label for="edit-name">College Name </label>
 <input type="text" id="edit-name" name="collegename" value="" size="30" maxlength="60" class="form-text" required />
</div>
<div class="form-item form-type-textfield form-item-name col-md-6">
  <label for="edit-name">Workshops</label>
 <select style="width:272px;height:40px;" name="workshop" required>
 <option>Soft Skills</option>
 <option>Cyber Security</option>
 <option>Ethical Hacking</option>
 <option>Security</option>
 <option>Server</option>
 <option>Networking</option></select>
 </div>
<div class="form-item form-type-textfield form-item-name col-md-6">
  <label for="edit-name">Certifications</label>
  <select style="width:272px;height:40px;" name="course" required>
...
<div class="form-item form-type-textfield form-item-subject col-md-6">
  <label for="edit-subject">Subject </label>
 <input type="text" id="edit-subject" name="subject" value="" size="30" maxlength="60" class="form-text"  required/>
</div>
