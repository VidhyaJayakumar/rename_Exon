  ...
  <div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="course-image">
           <div class="field field-name-field-course-image field-type-image field-label-hidden"><div class="field-items"><div class="field-item even"><img typeof="foaf:Image" src="images/Train-the-Trainer.jpg" style="width:100%;" alt="" height="650"/></div></div></div>        </div>
...
exoncorp Academy provides corporate training in emerging technologies like IT, project management, Scrum and Agile development, digital marketing, and more. With our live and online training solutions, we help companies and teams get the skills they need to succeed in the digital economy.
            ...
            <h3>Our Corporate training programs are categorized into</h3>
            <div class="row"><br>  
                                      <div class="clearfix col-md-4 col-sm-4 col-xs-12 feature-item ">
                                       <i class="fa fa-check"></i><span>High Impact Training</span><br>
                                       
                                       </div>
                                       <div class="clearfix col-md-4 col-sm-4 col-xs-12 feature-item ">
                                       <i class="fa fa-check"></i><span>Independent learning</span><br>
                                       
                                       </div>
                                       <div class="clearfix col-md-4 col-sm-4 col-xs-12 feature-item ">
                                       <i class="fa fa-check"></i><span>Regular Training</span><br>
...
This methodology is particularly helpful for Companies looking for ROI on the training budgets. This will also suit companies looking for intensive trainings to fulfil their project requirements. 
                  ...
                  <h3>Regular Training</h3><p align="justify">Exoncorp Academy has been a pioneer in Corporate trainings and has earned the reputation as a trusted partner . Training managers can find trainers and trainings for every training requirement of theirs. we deliver a comprehensive range of trainings and Certifications. Our ability to manage cross domain , multiple trainings have positively impacted our customer base.Our Program Coordinators would schedule a public or private batch for your training requirements based on the number of participants . These trainings are low on budgets and are quick to execute. 
</p>
                  <div class="course-features margin-top-45">
            <h3>5 -Top Reasons to Partner with us for your Training Needs.</h3>
            <div class="row"> <br> 
                                      <div class="clearfix col-md-12 col-sm-12 col-xs-12 feature-item ">
                                       <i class="fa fa-check"></i><span>100 + Seasoned Consultants on Board from the Industry with vast hands on Knowledge.</span><br>
                                       <i class="fa fa-check"></i><span>In House content Development Team to create Tailor Made training programs to suit your specific requirements.</span><br>
                                       <i class="fa fa-check"></i><span>30 expert Support personals to handle Customer Support Operations and Deliverables.</span><br>
                                       <i class="fa fa-check"></i><span>Transparency and Accountability for all our Commitments.</span><br>
                                       <i class="fa fa-check"></i><span>Best Rates as we Value your relationship first.</span><br>
