...
<?php include ("header.php");?>
	<div role="main" class="main main-page">
				...
				<div class="container">
											<div class="row">
							<div class="col-md-12">
																<div class="ptitle">Boot camp Training </div>
																<div id="breadcrumbs"><ul class="breadcrumb"><li><a href="http://exincorpacademy.com/">Home</a></li><li><a href="http://exincorpacademy.com/services.php">Services</a></li><li><a href="http://exincorpacademy.com/boot.php">Boot camp</a></li> </ul> </div>
							</div>
						</div>
									</div>
			</section>
  ...
  <div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="course-image">
           <div class="field field-name-field-course-image field-type-image field-label-hidden"><div class="field-items"><div class="field-item even"><img typeof="foaf:Image" src="images/boot-camp-training-in-vellore.jpg" style="width:100%;" alt="" height="650"/></div></div></div>        </div>
...
<br/>
        <div class="course-content">
          <div class="field field-name-body field-type-text-with-summary field-label-hidden"><div class="field-items"><div class="field-item even" property="content:encoded"> <h1>Boot Camp </h1><p align="justify">Due to the fast changing IT scenario, companies need to ensure that their employees go through quality training that provides cutting-edge knowledge, skills, and practical hands-on experience in a limited time frame. Our accelerated Boot Camps are a boon considering the time & budget constraints most enterprises juggle with. <br><br>
<p align="justify">
The most cost effective training solution that has emerged as a successful training format for our certification seeking IT professionals, are these Boot Camp training programs. Boot Camps are all about teaching specific skills, tools or technologies over a limited time span in a zero-distraction environment. Boot Camps have proven to be one of the most successful training formats for quickly and effectively delivering comprehensive skills to IT professionals at a low cost.
            ...
            <h3>Boot camp Training Programs </h3><br>
            <div class="row">  
                                      <div class="clearfix col-md-4 col-sm-4 col-xs-12 feature-item ">
                                       <i class="fa fa-check"></i><span>.NET & C, C++</span><br>
                                       
                                       </div>
                                       <div class="clearfix col-md-4 col-sm-4 col-xs-12 feature-item ">
                                       <i class="fa fa-check"></i><span>.NET & Software Testing</span><br>
                                       
                                       </div>
                                       <div class="clearfix col-md-4 col-sm-4 col-xs-12 feature-item ">
                                       <i class="fa fa-check"></i><span>C, C++ & Software Testing</span><br>
                              ...
                              <div class="row">  
                                      <div class="clearfix col-md-4 col-sm-4 col-xs-12 feature-item ">
                                       <i class="fa fa-check"></i><span>J2EE & Software Testing</span><br>
                                       
                                       </div>
                                       <div class="clearfix col-md-4 col-sm-4 col-xs-12 feature-item ">
                                       <i class="fa fa-check"></i><span>Java & C, C++</span><br>
                                       
                                       </div>
                                       <div class="clearfix col-md-4 col-sm-4 col-xs-12 feature-item ">
                                       <i class="fa fa-check"></i><span>Java & J2EE</span><br>
                              ...
                              <div class="row">  
                                      <div class="clearfix col-md-4 col-sm-4 col-xs-12 feature-item ">
                                       <i class="fa fa-check"></i><span>Java & Oracle</span><br>
                                       
                                       </div>
                                       <div class="clearfix col-md-4 col-sm-4 col-xs-12 feature-item ">
                                       <i class="fa fa-check"></i><span>Java & PHP</span><br>
                                       
                                       </div>
                                       <div class="clearfix col-md-4 col-sm-4 col-xs-12 feature-item ">
                                       <i class="fa fa-check"></i><span>Java & Software Testing</span><br>
                              ...
                              <div class="row">  
                                      <div class="clearfix col-md-4 col-sm-4 col-xs-12 feature-item ">
                                       <i class="fa fa-check"></i><span>Oracle & C, C++</span><br>
                                       
                                       </div>
                                       <div class="clearfix col-md-4 col-sm-4 col-xs-12 feature-item ">
                                       <i class="fa fa-check"></i><span>Oracle & J2EE</span><br>
                                       
                                       </div>
                                       <div class="clearfix col-md-4 col-sm-4 col-xs-12 feature-item ">
                                       <i class="fa fa-check"></i><span>Oracle & Software Testing</span><br>
                              ...
                              <div class="row">  
                                      <div class="clearfix col-md-4 col-sm-4 col-xs-12 feature-item ">
                                       <i class="fa fa-check"></i><span>PHP & C, C++</span><br>
                 ...
                 <div class="course-features margin-top-45">
            <h3>Infrastructure Career Programs</h3><br>
            <div class="row">  
                                      <div class="clearfix col-md-4 col-sm-4 col-xs-12 feature-item ">
                                       <i class="fa fa-check"></i><span>A+, N+ & Security+</span><br>
                                       
                                       </div>
                                       <div class="clearfix col-md-4 col-sm-4 col-xs-12 feature-item ">
                                       <i class="fa fa-check"></i><span>CCNA & CCNP</span><br>
                                       
                                       </div>
                                       <div class="clearfix col-md-4 col-sm-4 col-xs-12 feature-item ">
                                       <i class="fa fa-check"></i><span>CCNA Security and CCNP Security</span><br>
                              ...
                              <div class="row">  
                                      <div class="clearfix col-md-4 col-sm-4 col-xs-12 feature-item ">
                                       <i class="fa fa-check"></i><span>CCNA Voice v8.0 and CCNP Voice v8.0</span><br>
                                       
                                       </div>
                                       <div class="clearfix col-md-4 col-sm-4 col-xs-12 feature-item ">
                                       <i class="fa fa-check"></i><span>CCNA, CCNP, CCNA Voice v8.0 & CCNP Voice v8.0</span><br>
                                       
                                       </div>
                                       <div class="clearfix col-md-4 col-sm-4 col-xs-12 feature-item ">
                                       <i class="fa fa-check"></i><span>MCITP & CCNA</span><br>
                              ...
                              <div class="row">  
                                      <div class="clearfix col-md-4 col-sm-4 col-xs-12 feature-item ">
                                       <i class="fa fa-check"></i><span>MCITP & MCTS</span><br>
                                       
                                       </div>
                                       <div class="clearfix col-md-4 col-sm-4 col-xs-12 feature-item ">
                                       <i class="fa fa-check"></i><span>MCITP: Enterprise Administration & Server Administrator- Windows Server 2008</span><br>
                                       
                                       </div>
                                       <div class="clearfix col-md-4 col-sm-4 col-xs-12 feature-item ">
                                       <i class="fa fa-check"></i><span>MCSE 2003 & CCNA</span><br>
                              ...
                              <div class="row">  
                                      <div class="clearfix col-md-4 col-sm-4 col-xs-12 feature-item ">
                                       <i class="fa fa-check"></i><span>RHCE & CCNA</span><br>
                                       
                                       </div>
                                       <div class="clearfix col-md-4 col-sm-4 col-xs-12 feature-item ">
                                       <i class="fa fa-check"></i><span>RHCE & RHCVA</span><br>
                                       
                                       </div>
                                       <div class="clearfix col-md-4 col-sm-4 col-xs-12 feature-item ">
                                       <i class="fa fa-check"></i><span>RHCVA & RHCDS</span><br>
