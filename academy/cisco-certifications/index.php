...
<body class="html front not-logged-in no-sidebars page-home-edu-v1 page-no-margin not-preloader" >
  ...
  <div class="block-inner clearfix">
   ...
   <div class="grid-inner col-inner">
      <div class="image">  
            <div class="field-content"><img typeof="foaf:Image" src="../images\ccnet2.jpg" width="700" height="525" alt="" /></div>            
      </div>  
      <div class="item-body">
         <div class="title"> 
            <span class="field-content"><a href="cisco.php">CLOUD</a></span>         </div>  
         <div class="teacher"> 
            <div class="field-content">Selva</div>         </div>
         <div class="body">        
   ...
   <div class="grid-inner col-inner">
      <div class="image">  
            <div class="field-content"><img typeof="foaf:Image" src="../images/11115.jpg" width="700" height="525" alt="" /></div>        
      </div>  
      <div class="item-body">
         <div class="title"> 
   ...
   <div class="grid-inner col-inner">
      <div class="image">  
            <div class="field-content"><img typeof="foaf:Image" src="../images/11111.jpg" width="700" height="525" alt="" /></div>          
      </div>  
      <div class="item-body">
         <div class="title"> 
