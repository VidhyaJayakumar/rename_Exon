...
<body class="html not-front not-logged-in no-sidebars page-forum not-preloader" >
  ...
  <?php include("header.php");?>
	...
	<div role="main" class="main main-page">
				...
				<div class="container">
											<div class="row">
							<div class="col-md-12">
																<div class="ptitle">Forums</div>
																<div id="breadcrumbs"><ul class="breadcrumb"><li><a href="index.php">Home</a></li> </ul> </div>
							</div>
						</div>
									</div>
			</section>
					...
					<div class="row">
						...
						<div id="page-main-content" class="main-content col-md-12">
							...
							<div class="main-content-inner">
												...
												<li><a href="#">Log in</a> to post new content in the forum.</li>
										</ul>
  ...
  <tbody>
      ...
      <td colspan="4" class="container">
          ...
          <div class="name"><a href="#">Helps and Supports Forums</a></div>
                      <div class="description">Helps and Supports Forums</div>
                        </td>
          </tr>
      <tr id="forum-list-11" class="even">
      <td class="forum">
                <div class="indent">          <div class="icon forum-status-default" title="No new posts">
            <span class="element-invisible">No new posts</span>
          </div>
          <div class="name"><a href="#">Converting to Drupal</a></div>
                      <div class="description">Converting to Drupal</div>
                  </div>      </td>
              <td class="topics">
          0                  </td>
        <td class="posts">0</td>
      ...
      <td class="forum">
          ...
          <div class="name"><a href="#">Before you start</a></div>
                  </div>      </td>
              <td class="topics">
          0                  </td>
        <td class="posts">0</td>
      ...
      <td class="forum">
          ...
          <div class="name"><a href="#">Installing Drupal</a></div>
                  </div>      </td>
              <td class="topics">
          2                  </td>
        <td class="posts">2</td>
        <td class="last-reply">  <span class="submitted">
  By <span class="username" xml:lang="" about="/educar/users/admin" typeof="sioc:UserAccount" property="foaf:name" datatype="">admin</span> 2 years 4 months ago  </span>
</td>
          </tr>
      ...
      <td class="forum">
          ...
          <div class="name"><a href="#">Upgrading Drupal</a></div>
                      <div class="description">Upgrading Drupal</div>
                  </div>      </td>
              <td class="topics">
          1                  </td>
        <td class="posts">1</td>
  ...
  By <span class="username" xml:lang="" about="/educar/users/admin" typeof="sioc:UserAccount" property="foaf:name" datatype="">admin</span> 2 years 4 months ago  </span>
      ...
      <td colspan="4" class="container">
          ...
          <div class="name"><a href="#">General Discussions</a></div>
                      <div class="description">General Discussions Forums</div>
                        </td>
          </tr>
      ...
      <td class="forum">
          ...
          <div class="name"><a href="#">Translations</a></div>
                  </div>      </td>
              <td class="topics">
          0                  </td>
        <td class="posts">0</td>
      ...
      <td class="forum">
          ...
          <div class="name"><a href="#">Post installation</a></div>
                  </div>      </td>
              <td class="topics">
          0                  </td>
        <td class="posts">0</td>
      ...
      <td class="forum">
          ...
          <div class="name"><a href="#">Module development</a></div>
                  </div>      </td>
              <td class="topics">
          0                  </td>
        <td class="posts">0</td>
      ...
      <td class="forum">
          ...
          <div class="name"><a href="#">Theme development</a></div>
                  </div>      </td>
              <td class="topics">
          1                  </td>
        <td class="posts">4</td>
