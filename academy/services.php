	...
	<div role="main" class="main main-page">
				...
				<div class="container">
							...
							<div class="col-md-12">
																...
																<div id="breadcrumbs"><ul class="breadcrumb"><li><a href="http://exoncorpacademy.com/">Home</a></li> </ul> </div>
							</div>
						</div>
									</div>
			</section>
  ...
  <div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="course-image">
           <div class="field field-name-field-course-image field-type-image field-label-hidden"><div class="field-items"><div class="field-item even"><img typeof="foaf:Image" src="sites/default/files/on-site.jpg" width="100%" height="650" alt="" /></div></div></div>        </div>
...
<br/>
        <div class="course-content">
          ...
          <p align="justify"> With our years of experience in the IT industry we come out with new innovative methods of teachings. We further offer diverse combination training program options to choose from. These programs are designed to meet the various needs of the clients. We also offer distance learning services to our clients. Our combination option program has proved successful and the friendly training environments have gained immense appreciations from our clients. Some of our combination programs which our clients can choose are as follows.</p>
            ...
            <div class="course-subtitle">Application Software Career Programs</div>
            <div class="row">  
                                      <div class="clearfix col-md-6 col-sm-12 col-xs-12 feature-item "><i class="fa fa-check"></i><span>Services </span></div>
                                        <div class="clearfix col-md-6 col-sm-12 col-xs-12 feature-item clearfix last"><i class="fa fa-check"></i><span>On-Site Training</span></div>
                                        ...
                                        <div class="clearfix col-md-6 col-sm-12 col-xs-12 feature-item clearfix last"><i class="fa fa-check"></i><span>Upcoming Webinars</span></div>
                              </div>  
          </div>
