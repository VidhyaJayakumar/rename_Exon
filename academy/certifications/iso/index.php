...
<body class="html front not-logged-in no-sidebars page-home-edu-v1 page-no-margin not-preloader" >
   ...
   <!-- Header
	...
	<div role="main" class="main main-page">
				...
				<div class="container">
											<div class="row">
							<div class="col-md-12">
																<div class="ptitle">international organization of standardization  </div>
                                <div id="breadcrumbs"><ul class="breadcrumb"><li><a href="http://exincorpacademy.com/certifications">certification</a></li> <li><a href="http://exincorpacademy.com/certifications/iso" title="" class="active">iso</a></li> </ul></div>
							</div>
						</div>
									</div>
			</section>
  ...
  <div class="block-inner clearfix">
   ...
   <div class="grid-inner col-inner">
      <div class="image">  
            <div class="field-content"><img typeof="foaf:Image" src="../../../images/ISO-9001-2015-training-vellore.jpg" width="700" height="525" alt="" /></div>            
      </div>  
      <div class="item-body">
         <div class="title"> 
            <span class="field-content"><a href="#">ISO 9001:2015</a></span>         </div>  
         <div class="teacher"> 
            <div class="field-content">Selvarathinam</div>         </div>
         <div class="body">        
            <div class="field-content"><p>ISO 9001 is a standard that setsout the requirements for a management system. </p></div>         </div>
         <div class="readmore">        
            <a href="#">View more</a>
         </div>
      </div>
   ...
   <div class="grid-inner col-inner">
      <div class="image">  
            <div class="field-content"><img typeof="foaf:Image" src="../../../images/iso27001.jpg" width="700" height="525" alt="" /></div>        
      </div>  
      <div class="item-body">
         <div class="title"> 
            <span class="field-content"><a href="#">ISO 27001:2013</a></span>         </div>  
         <div class="teacher"> 
            <div class="field-content">Siva Priya</div>         </div>
         <div class="body">        
            <div class="field-content"><p> To protect the
information more companies
are ISO 27001 certified. </p></div>         </div>
         <div class="readmore">        
            <a href="#">View more</a>
         </div>
      </div>
