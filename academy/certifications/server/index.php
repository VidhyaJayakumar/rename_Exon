   ...
   <?php include ("../../header.php");?>
	<div role="main" class="main main-page">
				...
				<div class="container">
											<div class="row">
							<div class="col-md-12">
																<div class="ptitle">server</div>
																<div id="breadcrumbs"><ul class="breadcrumb"><li><a href="http://Exincorpacademy.com/certifications/">certification</a></li> <li><a href="http://Exincorpacademy.com/certifications/server/" title="">server</a></li> </ul> </div>
							</div>
						</div>
									</div>
			</section>
  ...
  <div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="course-image">
           <div class="field field-name-field-course-image field-type-image field-label-hidden"><div class="field-items"><div class="field-item even"><img typeof="foaf:Image" src="server.jpg" width="1000" height="650" alt="" /></div></div></div>        </div>
        ...
        <div class="course-meta clearfix">
              ...
              <div class="content">
                ...
                <span class="val"><div class="field field-name-field-course-teacher field-type-node-reference field-label-hidden"><div class="field-items"><div class="field-item even"><a href="#">Selvarathinam</a></div></div></div></span>
              </div>
            </div>-->
              ...
              <div class="content">
                <span class="lab">Teacher</span>
                <span class="val"><div class="field field-name-field-course-teacher field-type-node-reference field-label-hidden"><div class="field-items"><div class="field-item even">saran kumar</div></div></div></span>
              </div>
            </div>
              ...
              <div class="content">
                ...
                <span class="val"><div class="field field-name-field-course-teacher field-type-node-reference field-label-hidden"><div class="field-items"><div class="field-item even">Regular Track</div></div></div></span>
              </div>
            </div>
           ...
           <h3>Deliverables</h3><br>
            <div class="row">  
                                      <div class="clearfix col-md-6 col-sm-12 col-xs-12 feature-item "><i class="fa fa-check"></i><span>Training </span></div>
                                        ...
                                        <div class="clearfix col-md-6 col-sm-12 col-xs-12 feature-item "><i class="fa fa-check"></i><span>Books </span></div>
                                        <div class="clearfix col-md-6 col-sm-12 col-xs-12 feature-item clearfix last"><i class="fa fa-check"></i><span>CD's</span></div>
                                        <div class="clearfix col-md-6 col-sm-12 col-xs-12 feature-item "><i class="fa fa-check"></i><span>Participation Certificate</span></div>
                              </div>  
          </div>
        
        <div class="clearfix"></div>
                   <div class="course-lessons margin-top-45">
             <div class="course-subtitle margin-0"><h3>Topics Covered</h3></div>
               
                                  <div class="lesson-item">
                      <i class="icon fa fa-check-square-o"></i>
                      <span class="lesson-content">
                        <span class="lesson-title">Installing and Configuring Windows Server</span>
                      ...
                      <i class="icon fa fa-check-square-o"></i>
                      <span class="lesson-content">
                        <span class="lesson-title">Administering Windows Server</span>
                      ...
                      <i class="icon fa fa-check-square-o"></i>
                      <span class="lesson-content">
                        <span class="lesson-title">Configuring Advanced Windows Server Services</span>
                      ...
                      <i class="icon fa fa-check-square-o"></i>
                      <span class="lesson-content">
                        <span class="lesson-title">Designing and Implementing a Server Infrastructure</span>
                      ...
                      <i class="icon fa fa-check-square-o"></i>
                      <span class="lesson-content">
                        <span class="lesson-title">Implementing an Advanced Server Infrastructure</span>
                        <span class="lesson-duration">45 min</span>
                      </span>  
                  </div>
                      ...
                      <i class="icon fa fa-check-square-o"></i>
                      <span class="lesson-content">
                        <span class="lesson-title">TCP/IP Addressing and IPv6</span>
                        <span class="lesson-duration">55 min</span>
                      </span>  
                  </div>
                      ...
                      <i class="icon fa fa-check-square-o"></i>
                      <span class="lesson-content">
                        <span class="lesson-title">Protocols of the TCP/IP Protocol Suite</span>
                        <span class="lesson-duration">2 hours</span>
                      </span>  
                  </div>
                      ...
                      <i class="icon fa fa-check-square-o"></i>
                      <span class="lesson-content">
                        <span class="lesson-title">NAT and ICS</span>
                      ...
                      <i class="icon fa fa-check-square-o"></i>
                      <span class="lesson-content">
                        <span class="lesson-title">DHCP, Port Forwarding, and DMZ Hosts</span>
                        <span class="lesson-duration">75 min</span>
                      </span>  
                  </div>
                      ...
                      <i class="icon fa fa-check-square-o"></i>
                      <span class="lesson-content">
                        <span class="lesson-title">TCP/IP Troubleshooting Tools</span>
                        <span class="lesson-duration">60 min</span>
                      </span>  
                  </div>
                      ...
                      <i class="icon fa fa-check-square-o"></i>
                      <span class="lesson-content">
                        <span class="lesson-title">NetBIOS</span>
                        <span class="lesson-duration">75 min</span>
                      </span>  
                  </div>
                      ...
                      <i class="icon fa fa-check-square-o"></i>
                      <span class="lesson-content">
                        <span class="lesson-title">Network Troubleshooting - A Case Study</span>
                        <span class="lesson-duration">45 min</span>
                      </span>  
                  </div>
                      ...
                      <i class="icon fa fa-check-square-o"></i>
                      <span class="lesson-content">
                        <span class="lesson-title">Common Protocol Suites</span>
                        <span class="lesson-duration">55 min</span>
                      </span>  
                  </div>
                      ...
                      <i class="icon fa fa-check-square-o"></i>
                      <span class="lesson-content">
                        <span class="lesson-title">DNS</span>
                        <span class="lesson-duration">2 hours</span>
                      </span>  
                  </div>
                      ...
                      <i class="icon fa fa-check-square-o"></i>
                      <span class="lesson-content">
                        <span class="lesson-title">WAN Technologies</span>
                        <span class="lesson-duration">60 min</span>
                      </span>  
                  </div>
                      ...
                      <i class="icon fa fa-check-square-o"></i>
                      <span class="lesson-content">
                        <span class="lesson-title">Network Management</span>
                        <span class="lesson-duration">75 min</span>
                      </span>  
                  </div>
								 <div class="lesson-item">
                      <i class="icon fa fa-check-square-o"></i>
                      <span class="lesson-content">
                        <span class="lesson-title">Remote Access</span>
                        <span class="lesson-duration">2 hours</span>
                      </span>  
                  </div>
                      ...
                      <i class="icon fa fa-check-square-o"></i>
                      <span class="lesson-content">
                        <span class="lesson-title">Repair Tools</span>
                        <span class="lesson-duration">60 min</span>
                      </span>  
                  </div>
