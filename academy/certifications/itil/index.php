...
<body class="html front not-logged-in no-sidebars page-home-edu-v1 page-no-margin not-preloader" >
   ...
   <!-- Header
	...
	<div role="main" class="main main-page">
				...
				<div class="container">
											<div class="row">
							<div class="col-md-12">
																<div class="ptitle">information technology and infrastructure library </div>
                                <div id="breadcrumbs"><ul class="breadcrumb"><li><a href=http://exincorpacademy.com/certifications/>certification</a></li> <li><a href="http://exincorpacademy.com/certifications/itil" title="" class="active">itil</a></li> </ul> </div>
							</div>
						</div>
									</div>
			</section>
  ...
  <div class="block-inner clearfix">
   ...
   <div class="grid-inner col-inner">
      <div class="image">  
            <div class="field-content"><img typeof="foaf:Image" src="../../../images/itil.jpg" width="700" height="525" alt="" /></div>            
      </div>  
      <div class="item-body">
         <div class="title"> 
            <span class="field-content"><a href="#">Foundation</a></span>         </div>  
         <div class="teacher"> 
            <div class="field-content">Selvarathinam</div>         </div>
         <div class="body">        
            <div class="field-content"><p>ITIL Foundation Course Contains Detailed Explanation of ITIL Basics and Importance</p></div>         </div>
         <div class="readmore">        
            <a href="#">View more</a>
         </div>
      </div>
   ...
   <div class="grid-inner col-inner">
      <div class="image">  
            <div class="field-content"><img typeof="foaf:Image" src="../../../images/itilinter.jpg" width="700" height="525" alt="" /></div>        
      </div>  
      <div class="item-body">
         <div class="title"> 
            <span class="field-content"><a href="#">Intermediate</a></span>         </div>  
         <div class="teacher"> 
            <div class="field-content">Siva Priya</div>         </div>
         <div class="body">        
            <div class="field-content"><p>This ITIL course focuses on Service Operations during the service strategy,design.</p></div>         </div>
         <div class="readmore">        
            <a href="#">View more</a>
         </div>
      </div>
   ...
   <div class="grid-inner col-inner">
      <div class="image">  
            <div class="field-content"><img typeof="foaf:Image" src="../../../images/itilexpert.jpg" width="700" height="525" alt="" /></div>          
      </div>  
      <div class="item-body">
         <div class="title"> 
            <span class="field-content"><a href="#">Expert</a></span>         </div>  
         <div class="teacher"> 
            <div class="field-content">saran kumar</div>         </div>
         <div class="body">        
            <div class="field-content"><p>Become the complete ITIL Expert. Fast-track your career! </p></div>         </div>
         <div class="readmore">        
            <a href="#">View more</a>
         </div>
      </div>
