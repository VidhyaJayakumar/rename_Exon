...
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0" />
   <title>exincorp&reg; IT Academy - computer IT Training Institutes server,networking,security,hacking in vellore, IT Training Company in vellore, computer training institutes 
...
<body class="html front not-logged-in no-sidebars page-home-edu-v1 page-no-margin not-preloader" >
   ...
   <!-- Header
	...
	<div role="main" class="main main-page">
				...
				<div class="container">
											<div class="row">
							<div class="col-md-12">
																<div class="ptitle">cloud and big data </div>
																<div id="breadcrumbs"><ul class="breadcrumb"><li><a href=http://exincorpacademy.com/certifications/>certification</a></li> <li><a href="http://exincorpacademy.com/certifications/cloud-bigdata" title="" class="active">cloud and big data</a></li> </ul> </div>
							</div>
						</div>
									</div>
			</section>
  ...
  <div class="block-inner clearfix">
   ...
   <div class="grid-inner col-inner">
      <div class="image">  
            <div class="field-content"><img typeof="foaf:Image" src="../../../images/aws.jpg" width="700" height="525" alt="" /></div>            
      </div>  
      <div class="item-body">
         <div class="title"> 
            <span class="field-content"><a href="#">Amazon Web Services</a></span>         </div>  
         <div class="teacher"> 
            <div class="field-content">Selvarathinam</div>         </div>
         <div class="body">        
            <div class="field-content"><p align=justify>Amazon Web Services offers reliable, scalable, and inexpensive cloud computing services.</p></div>         </div>
         <div class="readmore">        
            <a href="#">View more</a>
         </div>
      </div>
   ...
   <div class="grid-inner col-inner">
      <div class="image">  
            <div class="field-content"><img typeof="foaf:Image" src="../../../images/cp.jpg" width="700" height="525" alt="" /></div>        
      </div>  
      <div class="item-body">
         <div class="title"> 
            <span class="field-content"><a href="#">Google Cloud Platform</a></span>         </div>  
         <div class="teacher"> 
            <div class="field-content">Siva Priya</div>         </div>
         <div class="body">        
            <div class="field-content"><p align=justify>Google Cloud Platform, offered by Google, is a suite of cloud computing services. </p></div>         </div>
         <div class="readmore">        
            <a href="#">View more</a>
         </div>
      </div>
   ...
   <div class="grid-inner col-inner">
      <div class="image">  
            <div class="field-content"><img typeof="foaf:Image" src="../../../images/gg.jpg" width="700" height="525" alt="" /></div>          
      </div>  
      <div class="item-body">
         <div class="title"> 
            <span class="field-content"><a href="#">Microsoft Azure Cloud</a></span>         </div>  
         <div class="teacher"> 
            <div class="field-content">saran kumar</div>         </div>
         <div class="body">        
            <div class="field-content"><p align="justify">Microsoft Azure is a growing collection of cloud services for our global network.</p></div>         </div>
         <div class="readmore">        
            <a href="#">View more</a>
         </div>
      </div>
