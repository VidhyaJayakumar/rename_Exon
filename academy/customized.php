  ...
  <div id="skip-link">
	...
	<div role="main" class="main main-page">
				...
				<div class="container">
											<div class="row">
							<div class="col-md-12">
																<div class="ptitle">Customized Training Programs</div>
																<div id="breadcrumbs"><ul class="breadcrumb"><li><a href="http://exincorpacademy.com/">Home</a></li> <li><a href="http://exincorpacademy.com/services.php">Services</a></li><li><a href="http://exincorpacademy.com/customized.php">customized training  </a></li> </ul> </div>
							</div>
						</div>
									</div>
			</section>
  ...
  <div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="course-image">
           <div class="field field-name-field-course-image field-type-image field-label-hidden"><div class="field-items"><div class="field-item even"><img typeof="foaf:Image" src="images/customized-training-in-vellore.jpg" width="100%" height="650" alt="" /></div></div></div>        </div>
...
<br/>
        <div class="course-content">
          <div class="field field-name-body field-type-text-with-summary field-label-hidden"><div class="field-items"><div class="field-item even" property="content:encoded"> <h1>Customized Training Programs</h1><p align="justify"><b>Thank you for considering Customised Training for your training needs.</b> <br/><br/>
		  At Customised Training our commitment is to provide you with high quality service and friendly trainers so that you can relax in the knowledge that we will do all that we can to support you in your educational journey to achieve your goals. <br/><br/>
		All courses can be fully customized course to suit your training need. Clients can start it from any date. The training is not the same as mentoring. It is actually instructor-led training where the instructor is present all the time and it is classroom training and not self learning. The training is rendered in compliance with the global quality norms and standards. <br/> <br/>
		Our customized training will be delivered by a highly-skilled audit professional who is also a talented facilitator. All of our facilitators draw upon personal knowledge and experience to make the learning "real" and produce more meaningful outcomes for your organization. <br/><br/>
		We look forward to working in partnership with you to reach your future goals. <br/><br/>
		Questions? Contact us to discuss your individual requirements. </p><br><br>
