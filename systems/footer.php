...
#flickr_badge_wrapper {width:330px;text-align:left;}
#flickr_badge_wrapper a {color: transparent;}
</style><div id="flickr_badge_wrapper"><script type="text/javascript" src="http://www.flickr.com/badge_code.gne?count=15&display=random&size=square&nsid=147246062@N02&raw=1"></script></div>        
            </div>
          </div>
			  ...
			  <form action="//exoncorpsystems.us12.list-manage.com/subscribe/post?u=dfe5272f08c9d01955434f95b&amp;id=f3033ca8f4" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
                <div class="input-group">
                  ...
                  <span class="input-group-btn">
                    <button class="btn btn-primary" id="mc-embedded-subscribe" type="submit">Subscribe</button>
                  </span>
                </div>
              </form>
            </div>
  ...
  <!--     <center><div id="JdBadge" data-s1="b1" data-s2="Y3RyY3QlNDAlNDAlNDA5OTk5UFg0MTYlMkJYNDE2JTJCMTUwNDA0MTc0NTU0JTJCSzhXMQ=="></div><div id="JdBadgeDest"></div><script type="text/javascript" src="https://www.justdial.com/Jd-Widget"></script></center> -->
    </div>
    <!-- END PRE-FOOTER -->
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 col-sm-6 padding-top-10">
           &copy; 2019 Exincorp Systems.&nbsp; &nbsp; Powered by <a href="#" title="web hosting vellore, website development vellore, exoncorpstudios">exoncorp Studios.</a>&nbsp; &nbsp; <a href="#">Privacy Policy</a> | <a href="#">Terms of Service</a>
          </div>
          <!-- END COPYRIGHT -->
          <!-- BEGIN PAYMENTS -->
