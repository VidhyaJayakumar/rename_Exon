...
<body class="wide">
                ...
                <div class="container">
					...
					<div class="row">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active"><a href="#">Case Study Details</a></li>
						</ol>
                    </div>
                    <!-- /.row -->
                            ...
                            <div class="card">
                            	<div class="card-block">
									...
									<blockquote class="blockquote mb-4">
										...
										<footer class="blockquote-footer">Purchase now on <cite title="Source Title">ThemeForest</cite></footer>
									</blockquote>

                                    <div class="row">
                                        <div class="col-md-6">
                                            <h6 class="text-muted">Before:</h6>
                                            <canvas id="beforeChart" height="180"></canvas>
                                        </div>
                                        <!-- /.col-md-6 -->
                                        <div class="col-md-6">
                                            <h6 class="text-muted">After:</h6>
                                            <canvas id="afterChart" height="180"></canvas>
                                        </div>
                                        <!-- /.col-md-6 -->
                                    </div>
                                    <!-- /.row -->

                                    <h5 class="text-muted mt-4">Problem:</h5>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <strong>Consectetur adipisicing elit, sed do eiusmod tempor in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</strong>
                                            <p>Sectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                                        </li>
                                        <li>
                                            <strong>Deiusmod tempor incididunt ut labore et dolore magna aliqua cillum dolore.</strong>
                                    ...
                                    <h5 class="text-muted mt-4">Solution:</h5>
	...
	<script>
		$(function() {
			...
			var ctx = document.getElementById("beforeChart");
			var data = {
            ...
            // After Chart
            var ctx2 = document.getElementById("afterChart");
			var data2 = {
			    labels: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul"],
			    datasets: [
			        {
            ...
            var barChartData = {
                ...
                datasets: [{
                    ...
                    borderWidth: 1,
                    data: [26, 27, 30, 34, 39, 49, 60, 72, 84, 95]
                }]
            };
